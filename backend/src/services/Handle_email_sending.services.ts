import { IfMail_Exist, Validte_Token_Mail, deleteToken_Mail, ifUserEmailExist, ifUserUsernameExist, setToken_Mail } from "./insertingData";
...
async function sendEmail(mail: string, socket: any) {
  var token = '';
    try {
